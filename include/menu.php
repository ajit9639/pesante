        ...
        <div class="col-md-8  col-sm-12 col-xs-12 col-sm-12">
          <nav class="navbar"> 
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="index.php"><img class="logo-dark hidden-xs"  src="images/Pesante.png" width="150px" alt="" /> <img class="logo-dark hidden-lg hidden-md hidden-sm"  src="images/Pesante.png" alt="" width="135px"/></a> </div>
