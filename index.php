...
?>
                    <li>
                        <a href="service_detail.php?id=<?= $row['id']?>">
                            ...
                            <p style="border: 2px solid;"><?= $row['name']?></p>
                        </a>
                    </li>
                    <?php } ?>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="icon_box_one">
                        ...
                        <div class="box_content">
                            ...
                            <p>All of our Helpers undergo rigorous identity checks and personal interviews. Your safety
                                is even our concern too.</p>
                            <!-- <a href="#" class="read-more">Read More <span class="glyphicon glyphicon-menu-right"></span></a>  -->
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="icon_box_one">
                        ...
                        <div class="box_content">
                            ...
                            <p>Our experienced taskers perform their tasks with dedication and perfection. We appreciate
                                your reviews about the service.</p>
                            <!-- <a href="#" class="read-more">Read More <span class="glyphicon glyphicon-menu-right"></span></a>  -->
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="icon_box_one">
                        ...
                        <div class="box_content">
                            ...
                            <p>Let us know if you have any specific equirement, otherwise our guys carry their own
                                supplies.</p>
                            <!-- <a href="#" class="read-more">Read More <span class="glyphicon glyphicon-menu-right"></span></a>  -->
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="icon_box_one">
                        ...
                        <div class="box_content">
                            ...
                            <p>Book your service online on one tap, keep a track of your service status and also keep in
                                touch with your Helper.</p>
                            <!-- <a href="#" class="read-more">Read More <span class="glyphicon glyphicon-menu-right"></span></a>  -->
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="counter_box text-center">
                        ...
                        <div class="counter_number_right">
                            <div class="counter_number counter"><span
                                    class="stat-count"><?php echo $facts['quality']; ?></span>%</div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="counter_box text-center">
                        ...
                        <div class="counter_number_right">
                            <div class="counter_number counter"><span
                                    class="stat-count"><?php echo $facts['workers']; ?></span>+</div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="counter_box text-center">
                        ...
                        <div class="counter_number_right">
                            <div class="counter_number counter"><span
                                    class="stat-count"><?php echo $facts['experience']; ?></span>+</div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="counter_box text-center">
                        ...
                        <div class="counter_number_right">
                            <div class="counter_number counter"><span
                                    class="stat-count"><?php echo $facts['customers']; ?></span>+</div>
        ...
        <div class="container text-center">
            ...
            <div class="row">
                            ...
                            <div class="cmsmasters_quote">
                                <article class="cmsmasters_quote_inner">
                                    <div class="cmsmasters_quote_img_info_wrap">
                                        <div class="cmsmasters_quote_image"><img src="images/02home/clinte2.png"
                                                alt="Kevin" /></div>
              ...
              ?>
                        ...
                        <div class="view_all"><a href="testimonial.php">View All Testimonails <i
    ...
    <section id="call-to-action">
        <div class="container free_consultation">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 m-text-center text-right"> <a href="contact.php"
                        class="btn btn-primary btn-outline">Contact Us</a> </div>
            </div>
        </div>
    </section>
    <!--Call To Action End-->
        ...
        <div class="container text-center">
            <div class="row text-left">
                <div class="col-md-2 col-sm-3 col-xs-12">
                    <h3 class="panel-heading">Our Clients</h3>
                </div>
                <div class="col-md-10 col-sm-12 col-xs-12">
                    <ul class="trusted_logo owl-carousel" id="trusted-slider">
                        <li><a href="#"><img src="images/clients/jusco.png" alt="logo1" /></a></li>
                        <li><a href="#"><img src="images/clients/tata.png" alt="logo2" /></a></li>
                        <li><a href="#"><img src="images/clients/tf.png" alt="logo3" /></a></li>
                        <li><a href="#"><img src="images/clients/trf.png" alt="logo4" /></a></li>
